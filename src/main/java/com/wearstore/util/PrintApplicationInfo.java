...
public class PrintApplicationInfo {
    ...
    public static void print(ConfigurableApplicationContext context){
        ...
        String swaggerUrl = "http://" + IpUtil.getLocalhostIp() + ":" + port + contextPath + (contextPath.endsWith("/") ? "" : "/") + "docs";
        log.info("home:{}", homeUrl);
        log.info("docs:{}", swaggerUrl);
        // log.info("wear-store start success...........");

        String startSuccess = "\n" +
                "             /$$                           /$$                                                                               \n" +
                "            | $$                          | $$                                                                               \n" +
                "  /$$$$$$$ /$$$$$$    /$$$$$$   /$$$$$$  /$$$$$$          /$$$$$$$ /$$   /$$  /$$$$$$$  /$$$$$$$  /$$$$$$   /$$$$$$$ /$$$$$$$\n" +
                " /$$_____/|_  $$_/   |____  $$ /$$__  $$|_  $$_/         /$$_____/| $$  | $$ /$$_____/ /$$_____/ /$$__  $$ /$$_____//$$_____/\n" +
                "|  $$$$$$   | $$      /$$$$$$$| $$  \\__/  | $$          |  $$$$$$ | $$  | $$| $$      | $$      | $$$$$$$$|  $$$$$$|  $$$$$$ \n" +
                " \\____  $$  | $$ /$$ /$$__  $$| $$        | $$ /$$       \\____  $$| $$  | $$| $$      | $$      | $$_____/ \\____  $$\\____  $$\n" +
                " /$$$$$$$/  |  $$$$/|  $$$$$$$| $$        |  $$$$/       /$$$$$$$/|  $$$$$$/|  $$$$$$$|  $$$$$$$|  $$$$$$$ /$$$$$$$//$$$$$$$/\n" +
                "|_______/    \\___/   \\_______/|__/         \\___/        |_______/  \\______/  \\_______/ \\_______/ \\_______/|_______/|_______/ \n" +
                "                                                                                                                             \n";
